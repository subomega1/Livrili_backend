...
public class DeliveryGuyPackController {
        ...
        @Operation(summary = "Get all packs for the delivery guy", description = "Retrieves a list of all packages available for the authenticated delivery guy.")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Successfully retrieved packs", content = @Content(schema = @Schema(implementation = DeliveryGuyPackResponseDto.class))),
        ...
        @Operation(summary = "Create an offer for a specific pack", description = "Allows a delivery guy to create an offer for a specific package. The offer details are provided in the request body.")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "201", description = "Offer created successfully", content = @Content(schema = @Schema(implementation = OfferResDto.class))),
        ...
        @Operation(summary = "Get all offers for the delivery guy", description = "Retrieves a list of all offers created by the authenticated delivery guy.")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Delivered packages retrieved successfully", content = @Content(schema = @Schema(implementation = ApprovedPackDto.class))),
                        @ApiResponse(responseCode = "200", description = "Successfully retrieved offers", content = @Content(schema = @Schema(implementation = GetOfferRes.class)))
        })
        ...
        @Operation(summary = "Get all approved packs for delivery", description = "Retrieves a list of all packages that have been approved for delivery by the authenticated delivery guy.")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Successfully retrieved approved packs", content = @Content(schema = @Schema(implementation = ApprovedPackDto.class))),
                        @ApiResponse(responseCode = "401", description = "Unauthorized - Invalid or missing authentication token")
        })
        @GetMapping("/approved")
        ...
        @Operation(summary = "Get all delivered packs", description = "Retrieves a list of all packages that have been marked as delivered by the authenticated delivery guy.")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Successfully retrieved delivered packs", content = @Content(schema = @Schema(implementation = ApprovedPackDto.class))),
                        @ApiResponse(responseCode = "401", description = "Unauthorized - Invalid or missing authentication token")
        ...
        @Operation(summary = "Update an existing offer", description = "Allows a delivery guy to update the details of an existing offer. The updated offer details are provided in the request body.")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Successfully updated offer", content = @Content(schema = @Schema(implementation = OfferResDto.class))),
                        @ApiResponse(responseCode = "400", description = "Bad Request - Invalid or incomplete data provided")
        })
        @PutMapping("/offer/{id}")
        ...
        @Operation(summary = "Mark a pack as delivered", description = "Allows a delivery guy to mark a specific package as delivered.")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Pack marked as delivered successfully", content = @Content(schema = @Schema(implementation = ApprovedPackDto.class))),
        ...
        @Operation(summary = "Delete an offer", description = "Allows a delivery guy to delete an existing offer.")
        @ApiResponses(value = {
