...
@RestController
@RequestMapping("v1/api/client/pack")
@CrossOrigin
...
public class ClientPackController {
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "201", description = "Package created successfully", content = @Content(schema = @Schema(implementation = Pack.class))),
                        ...
                        @ApiResponse(responseCode = "422", description = "Unprocessable Entity - Invalid or incomplete data provided", content = @Content(schema = @Schema(implementation = ApiErrorResponse.class)))
        })
        public ResponseEntity<Pack> addPack(@RequestBody PackRequestDto packRequestDto, HttpServletRequest request) {
                ...
                return new ResponseEntity<>(clientPackService.createPackForClient(uuid, packRequestDto),
                                HttpStatus.CREATED);
        }
        ...
        @ApiResponses({
                        ...
                        @ApiResponse(responseCode = "200", description = "Packages retrieved successfully", content = @Content(schema = @Schema(implementation = PackResponseDto.class)))
        ...
        public ResponseEntity<List<PackResponseDto>> getAllPacks(HttpServletRequest request) {
                ...
                List<PackResponseDto> packsResponse = packs.stream().map(packsForClientMapper::ToPackResponseDto)
                                .toList();
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "Package updated successfully", content = @Content(schema = @Schema(implementation = PackResponseDto.class))),
                        @ApiResponse(responseCode = "404", description = "Not Found - Package with the specified ID does not exist", content = @Content(schema = @Schema(implementation = ApiErrorResponse.class))),
                        @ApiResponse(responseCode = "422", description = "Unprocessable Entity - Invalid or incomplete data provided", content = @Content(schema = @Schema(implementation = ApiErrorResponse.class))),
                        @ApiResponse(responseCode = "200", description = "Packages retrieved successfully", content = @Content(schema = @Schema(implementation = PackResponseDto.class)))
        })
        public ResponseEntity<PackResponseDto> updatePack(@PathVariable UUID id, @RequestBody PackRequestDto request,
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "Package rated successfully", content = @Content(schema = @Schema(implementation = ApprovedPackDto.class))),
                        @ApiResponse(responseCode = "400", description = "Bad Request - Invalid rating data provided", content = @Content(schema = @Schema(implementation = ApiErrorResponse.class))),
                        @ApiResponse(responseCode = "200", description = "Packages retrieved successfully", content = @Content(schema = @Schema(implementation = PackResponseDto.class)))
        })
        public ResponseEntity<ApprovedPackDto> confirmAndRateDelivered(@PathVariable UUID id,
                        HttpServletRequest request, @RequestBody RattingRequestDto rattingRequestDto) {
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "Packages retrieved successfully", content = @Content(schema = @Schema(implementation = PackResponseDto.class))),
                        @ApiResponse(responseCode = "200", description = "Decision applied successfully", content = @Content(schema = @Schema(implementation = String.class)))
        })

        public ResponseEntity<String> applyDecision(@PathVariable UUID id, HttpServletRequest request,
                        @RequestBody OfferDecisionRequest offerDecisionRequest) {
                UUID clientId = (UUID) request.getAttribute("userId");
                return new ResponseEntity<>(
                                clientPackService.approvePackOrDeclineOffer(clientId, id, offerDecisionRequest),
                                HttpStatus.OK);
        }
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "Decision applied successfully", content = @Content(schema = @Schema(implementation = String.class))),
                        @ApiResponse(responseCode = "200", description = "Approved packages retrieved successfully", content = @Content(schema = @Schema(implementation = ApprovedPackDto.class)))
        })
        ...
        public ResponseEntity<List<ApprovedPackDto>> getApprovedPacks(HttpServletRequest request) {
                ...
                List<ApprovedPackDto> approvedPacks = packs.stream().map(approvedPackMapper::toApprovedPackDto)
                                .toList();
